...
public class EmailGmailService extends HtmlEmail implements Sendable {
    ...
    public Boolean sendWelcome(String receiverName,String receiverEmail) {
        try {
            ...
            setHtmlMsg("<div style=\"width:100%;font-family:arial,'helvetica neue',helvetica,sans-serif;padding:0;Margin:0\">\n" +
    ...
    public Boolean sendChangePassword(String receiverName,String receiverEmail) {
        ...
        try {
            ...
            setHtmlMsg("""
                    ...
                    \t\t<center style='color:#ffffff; font-family:verdana, geneva, sans-serif; font-size:15px; font-weight:400; line-height:15px;  mso-text-raise:1px'>Alterar senha</center>
                    \t</v:roundrect></a>
                    <![endif]--><!--[if !mso]><!-- --><span class="msohide es-button-border" style="border-style:solid;border-color:#2cb543;background:#f14866;border-width:0px;display:inline-block;border-radius:5px;width:auto;mso-border-alt:10px;mso-hide:all"><a href="" class="es-button" target="_blank" style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:18px;display:inline-block;background:#f14866;border-radius:5px;font-family:verdana, geneva, sans-serif;font-weight:normal;font-style:normal;line-height:22px;width:auto;text-align:center;padding:10px 20px 10px 20px;border-color:#f14866">Alterar senha</a></span><!--<![endif]--></td>
                                         </tr>
                                       </table></td>
                                     </tr>
                                   </table></td>
